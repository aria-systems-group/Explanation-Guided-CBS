...
// void A_star::canonicalPath(Node *curr)
// {
...
bool A_star::checkPathValidity(Node *curr)
{
...
int A_star::getMaxCost(std::vector<std::vector<State*>> existSol)
{
	int max_seg = 0;
	int missing  = 0;
...
int A_star::noIntersectCheck(Node* curr, std::vector<std::vector<State*>> existingSol)
{
